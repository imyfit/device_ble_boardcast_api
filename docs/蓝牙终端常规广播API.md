...
| 字节顺序 |    内容    | 说明                                                         |
| :------: | :--------: | ------------------------------------------------------------ |
|    1     |  运动模式  | 非0x00 见[蓝牙协议文档](http://imyfit.gitee.io/device-ble-conn-api/#/?id=%e8%bf%90%e5%8a%a8%e8%ae%b0%e5%bd%95-%e7%b1%bb%e5%9e%8b0x01)运动记录部分 |
|          |  运动数据  | 1B(类型码) + nB(类型数据) + <br />1B(类型码) + nB(类型数据) + <br />... |
|          | 异或校验值 | 0xB8 至字节该字节前的异或校验值                              |
...
| 0x0B       | 2                | 划水次数                |
| 0x0C       | 2                | 来回趟数                |
| 0x0D       | 2                | 划水频率（strokes/min） |
| 0x0E       | 2                | 最大耗氧量（ml/kg/min） |
|            |                  |                         |
