...
|  数据1   | bit[0] ：佩戴 1佩戴，0未佩戴<br />bit[1] ：保留<br />bit[2] ：充电器插入状态，1-插入；0-未插入<br />bit[3] ：充电状态，1-充电中；0-未充电/充满<br />bit[4] ：SOS状态，1-报警；0-正常<br />bit[5] ：拆带与否，1未拆；0已拆<br />bit[6] ：动静状态，1-动；0-静<br />bit[7] ：运动模式，1-开启；0-关闭 |
|  数据2   | 软件版本                                                     |
